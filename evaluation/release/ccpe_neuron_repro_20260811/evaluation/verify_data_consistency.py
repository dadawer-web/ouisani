...
EXCLUDES = {
    ...
    # CCPE-specific executor replication; it is analyzed separately so the
    # frozen Computing manuscript remains reproducible at 19 core/capacity runs.
    "jvm_permission_starvation_ccpe_core_01.raw.jsonl",
}
...
def main() -> int:
    ...
    for excluded in sorted(EXCLUDES):
        analyze_command.extend(["--exclude", excluded])
