...
reproducibility is consequently an explicit limitation.  To provide a
longer-lived open-model sensitivity point, we additionally record a local
Ollama Qwen2-family \texttt{qwen:7b} digest and its 100 valid trial log; this
does not make the provider-mediated results immutable or substitute for a
fixed hosted-provider checkpoint.
