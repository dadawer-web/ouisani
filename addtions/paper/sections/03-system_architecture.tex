...
The production \texttt{EscalationPolicy} implements this function. The
resource signal is produced by the production
...
failure does not silently convert a denial to an allow; a production system
...
The evaluation manipulates steps 2--5 while keeping the production admission
